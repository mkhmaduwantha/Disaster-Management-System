...
def home():
    ...
    if form.validate_on_submit:
        if request.method == 'POST':
            ...
            form.subject.data = ''
            form.message.data = ''
            return rediretc('main.home')
    # flash(
    # f'Thank you for your feedback', 'success')
    return render_template('main/home.html', form=form, camps=camps, is_true=True)
...
def disaster(name):
    ...
    return render_template('main/disaster_details.html', values=values, labels=labels_split, legend=legend, details=details, reference=reference, dos=dos, donts=donts, html=html, image_files=image_files)
...
def getmap():
    ...
    return render_template('main/map.html', html=m.get_root().render())
